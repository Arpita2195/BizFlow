    ...
    <div className="min-h-screen bg-[#F4EFE6] text-[#1A1512] flex flex-col">
      <header className="px-6 lg:px-12 h-16 flex items-center justify-between border-b border-bronze/15 bg-white/40">
        ...
        <div className="flex items-center gap-3">
          <span className="text-xs font-semibold text-[#C9A24B] bg-[#C9A24B]/15 px-3 py-1 rounded-full border border-[#C9A24B]/30 flex items-center gap-1">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="max-w-4xl w-full">
          <div className="text-center mb-12">
            <span className="text-xs font-bold text-[#C9A24B] uppercase tracking-widest">Interactive Freelance Showcase</span>
            ...
            {demoBusinesses.map((b) => {
              ...
              return (
                <button
                  ...
                  className="text-left p-6 rounded-2xl border border-bronze/20 bg-white/70 hover:bg-white hover:border-[#C9A24B] hover:shadow-2xl transition-all duration-200 group flex flex-col justify-between h-full"
                >
                  <div>
                    <div className="w-12 h-12 rounded-xl bg-[#C9A24B]/20 border border-[#C9A24B]/30 flex items-center justify-center mb-4">
                      <Icon size={22} className="text-[#3D2B1F]" />
                    </div>
                    <span className="text-[10px] font-bold text-[#C9A24B] uppercase tracking-wider">{b.type} Vertical</span>
                  ...
                  <span className="text-xs font-bold text-espresso inline-flex items-center gap-1.5 pt-3 border-t border-bronze/15 w-full">
                    ...
                    <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform text-[#C9A24B]" />
                  </span>
                </button>
              );
            })}
